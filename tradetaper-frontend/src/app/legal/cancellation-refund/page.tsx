    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50/30 to-violet-50/50 dark:from-gray-900 dark:via-black dark:to-gray-900">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-4">
                <Link href="/" className="flex items-center space-x-2 text-gray-900 dark:text-white hover:text-purple-600 dark:hover:text-emerald-400 transition-colors">
                  <Image
                ...
                <div className="flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400">
                  <span>/</span>
                  <Link href="/legal" className="hover:text-purple-600 dark:hover:text-emerald-400 transition-colors">Legal</Link>
                  <span>/</span>
      ...
      <div className="relative py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          {/* Status Badge */}
          <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-purple-500/10 to-violet-500/10 backdrop-blur-sm px-6 py-3 rounded-full text-purple-700 dark:text-emerald-300 text-sm font-medium mb-8 border border-purple-200/30 dark:border-emerald-800/30">
            <FaMoneyBillWave className="w-4 h-4" />
            <span>Billing & Refunds</span>
            <div className="w-2 h-2 bg-purple-500 rounded-full animate-pulse"></div>
            <span className="text-purple-700 dark:text-emerald-400">Fair Policy</span>
          </div>
          
          <h1 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-gray-900 via-purple-800 to-violet-900 dark:from-white dark:via-emerald-200 dark:to-emerald-200 bg-clip-text text-transparent mb-6">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-24">
        ...
        <div className="bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl rounded-3xl border border-gray-200/50 dark:border-gray-700/50 shadow-2xl overflow-hidden">
          {/* Document Header */}
          <div className="bg-gradient-to-r from-purple-50/80 to-violet-50/80 dark:from-emerald-900/20 dark:to-emerald-900/20 px-8 py-6 border-b border-gray-200/50 dark:border-gray-700/50">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
          ...
          <div className="px-8 py-12">
            <MarkdownContent 
              ...
              className="prose prose-xl prose-gray dark:prose-invert max-w-none
                ...
                prose-h2:text-3xl prose-h2:mt-16 prose-h2:mb-8 prose-h2:text-purple-900 dark:prose-h2:text-emerald-100
                prose-h3:text-2xl prose-h3:mt-12 prose-h3:mb-6 prose-h3:text-violet-800 dark:prose-h3:text-emerald-200
                prose-p:text-gray-700 dark:prose-p:text-gray-300 prose-p:leading-relaxed prose-p:mb-8 prose-p:text-lg
                prose-a:text-purple-600 dark:prose-a:text-emerald-400 prose-a:no-underline hover:prose-a:underline prose-a:font-medium
                ...
                prose-blockquote:border-l-4 prose-blockquote:border-purple-500 prose-blockquote:bg-purple-50/50 dark:prose-blockquote:bg-emerald-900/20 prose-blockquote:pl-8 prose-blockquote:py-6 prose-blockquote:my-8 prose-blockquote:rounded-r-lg
                prose-code:text-purple-600 dark:prose-code:text-emerald-400 prose-code:bg-purple-50 dark:prose-code:bg-emerald-900/20 prose-code:px-2 prose-code:py-1 prose-code:rounded prose-code:font-medium"
            />
          </div>
        </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                ...
                <div className="space-y-4">
                  ...
                  <Link 
                    href="/pricing"
                    className="flex items-center justify-between p-4 bg-purple-50/80 dark:bg-emerald-900/20 rounded-lg hover:bg-purple-100 dark:hover:bg-emerald-900/30 transition-colors group"
                  >
                    <div className="flex items-center space-x-3">
                      <FaMoneyBillWave className="text-purple-600 dark:text-emerald-400 text-sm" />
                      <span className="text-gray-900 dark:text-white font-medium">View Pricing Plans</span>
                    </div>
                    <span className="text-purple-600 dark:text-emerald-400 group-hover:translate-x-1 transition-transform">→</span>
                  </Link>
                </div>
              </div>
            </div>
              ...
              <div className="flex-1">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-3 bg-gray-50/80 dark:bg-gray-800/80 rounded-lg">
                    ...
                    <span className="text-purple-600 dark:text-emerald-400 font-semibold">&lt; 4 hours</span>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-gray-50/80 dark:bg-gray-800/80 rounded-lg">
