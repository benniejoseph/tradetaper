  ...
  const notificationGroups = [
    ...
    },
    {
      ...
      types: [
        ...
        { type: NotificationType.WEEKLY_PERFORMANCE_DIGEST, label: 'Weekly Performance Digest' },
        { type: NotificationType.MONTHLY_PERFORMANCE_DIGEST, label: 'Monthly Performance Digest' },
      ],
    },
    {
      title: 'Community',
