...
import { LivePosition, LivePositionsResponse, terminalService } from '@/services/terminalService';
...
export default function LivePositionsCard({ accountId, accountName, hasMT5Accounts }: LivePositionsCardProps) {
  ...
  return (
    <DashboardCard
      ...
      icon={FaBolt}
      infoContent="Streams open MT5 positions with live P&L, direction, and distance-to-target/stop context."
    ...
    >
      ...
      {hasMT5Accounts && !accountId && (
        <div className="text-center py-6 text-sm text-gray-500 dark:text-gray-400">
          Select an MT5 account from the header to see live trade progress.
        </div>
      )}
        ...
        <>
          <div className="mb-3 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-wrap items-center gap-2 text-xs">
              ...
              <span className="text-gray-500 dark:text-gray-400">Updated {formatTimeAgo(data?.positionsUpdatedAt)}</span>
            </div>
          </div>
          ...
          <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div className="flex items-center rounded-full bg-gray-100 dark:bg-emerald-950/40 p-1 text-[10px]">
          ...
          {loading && !data && (
            <div className="py-6 text-center text-gray-500 dark:text-gray-400">Loading live positions...</div>
          )}
          ...
          {data && !data.enabled && (
            <div className="py-6 text-center text-gray-500 dark:text-gray-400">
              Auto-sync is not enabled for this MT5 account.
            </div>
          )}
