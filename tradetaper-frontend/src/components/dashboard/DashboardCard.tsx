...
export default function DashboardCard({
  ...
  return (
    <div className={`group relative bg-white/80 dark:bg-black/80 backdrop-blur-xl rounded-2xl border border-gray-200/50 dark:border-gray-700/50 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 overflow-hidden ${gridSpan} ${className}`}>
      ...
      <div className="relative z-10 flex items-center justify-between p-6 border-b border-gray-200/30 dark:border-gray-700/30">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <div className="w-8 h-0.5 bg-gradient-to-r from-emerald-500 to-emerald-600 mt-1"></div>
          </div>
          {showInfoIcon && (
            <button className="p-1.5 rounded-lg text-gray-400 hover:text-emerald-500 hover:bg-emerald-50 dark:hover:bg-emerald-950/30 transition-all duration-200">
        ...
        <div className="flex items-center space-x-3">
          {showTimeRangeSelector && (
            <div className="flex items-center bg-gray-100/80 dark:bg-[#141414]/80 p-1 rounded-xl backdrop-blur-sm">
      ...
      <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-emerald-400/10 to-emerald-600/10 rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
    </div>
  );
} 