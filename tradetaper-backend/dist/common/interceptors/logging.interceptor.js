    ...
    intercept(context, next) {
        ...
        return next.handle().pipe((0, operators_1.tap)({
            ...
            error: (error) => {
                ...
                this.logger.logApiCall(method, url, statusCode, duration, userId, error);
                if (statusCode === 401 || statusCode === 403) {
                    this.logger.logSecurityEvent(`Authentication failure on ${url}`, userId, ip, userAgent, 'medium');
                }
            },
        }));
    }
