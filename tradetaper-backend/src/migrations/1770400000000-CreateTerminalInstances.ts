...
export class CreateTerminalInstances1770400000000 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.createForeignKey("terminal_instances", new TableForeignKey({
        ...
        await queryRunner.createIndex("terminal_instances", new TableIndex({
