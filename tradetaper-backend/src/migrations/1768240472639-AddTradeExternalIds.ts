...
export class AddTradeExternalIds1768240472639 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "trades" ADD "externalId" character varying(255)`,
    );
    await queryRunner.query(
      `ALTER TABLE "trades" ADD "externalDealId" character varying(255)`,
    );
    await queryRunner.query(`ALTER TABLE "trades" ADD "mt5Magic" bigint`);
    await queryRunner.query(
      `CREATE INDEX "IDX_trades_externalId" ON "trades" ("externalId") `,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "trades" DROP COLUMN "externalDealId"`,
    );
