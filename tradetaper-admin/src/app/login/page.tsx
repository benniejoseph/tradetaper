...
function LoginForm() {
  ...
  return (
    <div className="admin-card admin-card-panel-roomy">
    ...
    >
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          ...
          style={{ background: 'radial-gradient(circle, var(--accent-primary-hover), transparent)' }}
        />
      </div>
      ...
      >
        <Suspense
          fallback={
            <div className="admin-card admin-card-panel-roomy text-center">
              <Loader2
